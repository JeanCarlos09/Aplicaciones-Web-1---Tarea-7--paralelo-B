...
form.addEventListener('submit', function(event) {
  ...
  // Nombre
// Seleccionar el input del nombre
const nameInput = document.getElementById('name');
// Seleccionar el mensaje de error para el nombre
const nameError = document.querySelector('#name + .error-message');
if (nameInput.value.trim() === '') { // Verificar si el campo está vacío
  nameError.textContent = 'El nombre es obligatorio.'; // Mostrar mensaje de error
  isValid = false; // Marcar como no válido
} else {
  nameError.textContent = ''; // Borrar mensaje de error
}

// Apellido
// Seleccionar el input del apellido
const surnameInput = document.getElementById('surname');
// Seleccionar el mensaje de error para el apellido
const surnameError = document.querySelector('#surname + .error-message');
if (surnameInput.value.trim() === '') { // Verificar si el campo está vacío
  surnameError.textContent = 'El apellido es obligatorio.'; // Mostrar mensaje de error
  isValid = false; // Marcar como no válido
} else {
  surnameError.textContent = ''; // Borrar mensaje de error
}
